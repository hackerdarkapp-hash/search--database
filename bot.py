...
يمكنك أيضًا البحث عن البيانات في وقت واحد بواسطة عدة طلبات. للقيام بذلك ، حدد كل طلب على خط منفصل ويتم تنفيذه في وقت واحد.""",
    ...
    elif data in ("menu_api", "menu_db_list", "menu_gift"):
    ...
    # ─── الأسئلة الشائعة ─────────────────────────────────────────────────────
        ...
        bot.answer_callback_query(call.id)
        mk = InlineKeyboardMarkup()
        mk.row(InlineKeyboardButton(text=DEVELOPER_TEXT, url=DEVELOPER_URL))
        mk.row(InlineKeyboardButton(text="↩️ رجوع", callback_data="menu_back"))
        bot.send_message(
            call.message.chat.id,
            """🤖 دليل استخدام بوت البحث في قواعد البيانات

━━━━━━━━━━━━━━━━━━━━━━
🚀 كيف تبدأ؟
━━━━━━━━━━━━━━━━━━━━━━
أرسل طلبك مباشرةً دون أوامر:

📧 بريد إلكتروني: example@gmail.com
📱 رقم هاتف: +79001234567
👤 اسم: Petrov Ivan
📍 IP: 127.0.0.1
🚗 لوحة سيارة: O999МУ777

البوت يتعرف على نوع الطلب تلقائياً ويبحث في عشرات قواعد البيانات دفعةً واحدة.

━━━━━━━━━━━━━━━━━━━━━━
📊 كيف تقرأ النتائج؟
━━━━━━━━━━━━━━━━━━━━━━
• كل زر = قاعدة بيانات وجدت فيها معلومات
• ◀️ ▶️ للتنقل بين صفحات نفس القاعدة
• ⬅️ ➡️ للتنقل بين قواعد البيانات المختلفة
• 📥 "تحميل النتائج" يُرسل ملف HTML كامل للحفظ

━━━━━━━━━━━━━━━━━━━━━━
📝 البحث الجماعي
━━━━━━━━━━━━━━━━━━━━━━
أرسل عدة طلبات كل واحد في سطر:

احمد محمد
+9671234567
admin@company.com

كل سطر يُنفَّذ بشكل مستقل وتحصل على ملخص بالنتائج مع زر تحميل لكل البيانات في ملف HTML واحد.

━━━━━━━━━━━━━━━━━━━━━━
🪙 نظام الرموز (Tokens)
━━━━━━━━━━━━━━━━━━━━━━
• كل بحث يستهلك رموزاً من رصيدك
• الرموز تتجدد تلقائياً بمعدل ثابت كل ثانية
• ترقية "الحد الأقصى للرموز" تمنحك سعةً أكبر
• ترقية "سرعة التجديد" تُسرّع معدل استعادة الرموز

━━━━━━━━━━━━━━━━━━━━━━
👥 نظام الإحالة
━━━━━━━━━━━━━━━━━━━━━━
• شارك رابط إحالتك واكسب من كل مستخدم يسجل عبرك
• 20% من مدفوعات إحالاتك المباشرة
• 5% من مدفوعات إحالات إحالاتك
• 0.1$ بونص عن كل مستخدم يُجري أول بحث

━━━━━━━━━━━━━━━━━━━━━━
💡 نصائح للحصول على أفضل النتائج
━━━━━━━━━━━━━━━━━━━━━━
• يمكنك دمج أكثر من معلومة في طلب واحد:
  بتروف 79002206090
  admin@site.com 123qwe
  ماكسيم موسكو 02/16/1995

• كلما أضفت تفاصيل أكثر كانت النتائج أدق
• البحث بالبريد + كلمة المرور يعطي أفضل تطابق

━━━━━━━━━━━━━━━━━━━━━━
👨‍💻 المطور — خدمات الأمن السيبراني والبرمجة
━━━━━━━━━━━━━━━━━━━━━━
هل تحتاج خدمة مخصصة؟ المطور متاح لـ:

🔐 الأمن السيبراني:
  • اختبار اختراق وتقييم الثغرات
  • تحليل وكشف التسريبات
  • تأمين الأنظمة والخوادم
  • استشارات حماية البيانات

💻 البرمجة والتطوير:
  • بوتات تيليغرام متقدمة
  • أدوات OSINT مخصصة
  • واجهات API وتكاملات
  • أتمتة المهام والسكريبتات

المطور يتمتع بخبرة عملية موثوقة وسجل حافل من المشاريع الناجحة. التواصل المباشر يضمن لك خدمة سريعة وسرية تامة.""",
            reply_markup=mk
        )
  ...
  if not api_token:
      _missing.append("API_TOKEN")
  if _missing:
      print(f"❌ خطأ: المتغيرات التالية غير مضبوطة في Render: {', '.join(_missing)}")
      print("   أضفها من: Render Dashboard -> اختر الخدمة -> Environment -> Add Environment Variable")
      import sys
      sys.exit(1)
